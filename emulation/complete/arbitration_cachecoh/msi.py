...
async def on_processor_event(state: MSIState, event: ProcessorEvent) -> TransitionResult:
    """
...
async def on_snoop_event(state: MSIState, event: SnoopEvent) -> TransitionResult:
    """
